...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://www.prediction-2020.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-07-24", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/prediction-2020",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/512619478",
					external: true,
